...
const ProjectPortfolioDetail = () => (
  <section className="section-padding bg-white min-h-screen flex items-center justify-center">
    <div className="w-full max-w-5xl bg-white rounded-xl shadow-none p-8 mx-auto">
      <img src={`${import.meta.env.BASE_URL}image_portfolio1.png`} alt="Portfolio site" className="w-full h-64 object-cover rounded-lg mb-8" />
      ...
      <div className="flex space-x-4 mt-6">
        <a href="https://github.com/Tokuhiro1103/Portfolio1" target="_blank" rel="noopener noreferrer" className="btn-secondary">GitHub</a>
      </div>
